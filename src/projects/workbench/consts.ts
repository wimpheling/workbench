...
export const enclosureThicknessWithoutInnerWall =
  ENCLOSURE_FOAM_THICKNESS + ENCLOSURE_SOUND_INSULATOR_THICKNESS + ENCLOSURE_WALL_THICKNESS;
...
export const enclosureWallInnerTopWidth = TABLE_WIDTH - 2 * enclosureThicknessWithoutInnerWall;
...
export const enclosureOuterY = FOOT_HEIGHT + TABLE_TOP_THICKNESS + ENCLOSURE_HEIGHT / 2;
export const enclosureInnerZ =
  0 - TABLE_DEPTH / 2 + innerLateralEnclosureDepth / 2 + enclosureThicknessWithoutInnerWall;
