...
export const SLIDING_PANEL_WIDTH = ENCLOSURE_VIGA_THICKNESS * 2 + ENCLOSURE_FOAM_THICKNESS;
...
export const LATERAL_WIDTH_PIECE_2_WIDTH = Math.round((ENCLOSURE_WIDTH * 1) / 3);
