...
def containment_notes(model: dict) -> str:
    ...
    lines = [
        ...
        + ".",
        "Front doors: 6 mm inset of profile fronts behind Y=-30 frame face; six CFG.30/30 hinges with 6 mm moving-wing spacers, eight door and four front-frame CJP3030L plates. Open right then left to 100 degrees; close in reverse. No fixed centre post. Slot-holder study supports at most 6 mm front infill, with product/compound, glass setting support and wood moisture movement unresolved. FSP08 is NOT specified for 6 mm glass. Rear closing strips need 12 mm backing and unselected compressible seals; fixing pitch, stops, latch force and sag pending.",
