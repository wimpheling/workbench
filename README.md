...
The active model uses millimetres internally. `toMillimetres()` is the explicit boundary for legacy centimetre/metre inputs. EnclosureV2 dimensions are parameters, not golden test values.
